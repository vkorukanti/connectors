...
public class TableImpl implements Table, Logging {
    ...
    public static Table forPath(String path, TableHelper helper, ScanEnvironment scanEnvironment) {
        ...
        return new TableImpl(logPath, dataPath, helper, scanEnvironment);
    }

    public final Path logPath;
    public final Path dataPath;
    public final TableHelper tableHelper;
    public final ScanEnvironment scanEnvironment;
